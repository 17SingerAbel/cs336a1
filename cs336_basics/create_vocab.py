...
input_filepath = 'TinyStoriesV2-GPT4-valid.txt'
# input_filepath = 'owt_valid.txt'
# input_filepath = 'owt_train.txt'
input_file_prefix =  input_filepath.split('.')[0]
print(input_file_prefix)

vocab_heap, merges_heap = train_bpe_heap(input_path=f'data/{input_file_prefix}.txt', vocab_size=10000,special_tokens=['<|endoftext|>'])
